...
const THEME_META: Record<Theme, { color: string; emoji: string | null; title: string }> = {
  ...
  eid:       { color: 'text-yellow-400 hover:text-yellow-200',   emoji: '🌙',  title: 'Parchment mode 📜'          },
  parchment: { color: 'text-amber-800 hover:text-amber-900',     emoji: '📜',  title: 'Switch to light mode ☀️'   },
