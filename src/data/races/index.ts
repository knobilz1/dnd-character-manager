...
export const ALL_RACES: Race[] = [
  ...
  },
  {
    ...
    traits: [
      ...
      { name: 'Fey Step', description: 'As a bonus action, teleport up to 30 feet to an unoccupied space you can see. You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest. At 3rd level, gain a seasonal extra effect (Autumn, Winter, Spring, Summer).' },
  ...
  },
  {
    ...
    traits: [
      ...
      { name: 'Rabbit Hop', description: 'As a bonus action, you can jump a number of feet equal to five times your proficiency bonus, without provoking opportunity attacks. You can use this trait a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest. You also regain one expended use when you finish a short rest.' },
    ],
    languages: ['Common', 'one of your choice'],
    isSubrace: false,
  },
  ...
  },
  {
    ...
    traits: [
      { name: 'Creature Type', description: 'You are a Humanoid (elf).' },
      { name: 'Darkvision', description: 'You can see in dim light within 60 feet as if it were bright light.' },
      { name: 'Blessing of the Raven Queen', description: 'As a bonus action, teleport up to 30 feet. You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest. At 3rd level, also gain resistance to all damage until the start of your next turn after teleporting.' },
      { name: 'Fey Ancestry', description: 'Advantage on saves against being charmed; magic can\'t put you to sleep.' },
