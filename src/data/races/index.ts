...
export const ALL_RACES: Race[] = [
  ...
  // ── FToD: Dragonborn Variants ──────────────────────────────────────────
  {
    ...
    abilityScoreIncreases: { str: 2, cha: 1 },
    traits: [
      { name: 'Chromatic Ancestry', description: 'Choose: Black (acid), Blue (lightning), Green (poison), Red (fire), or White (cold). You have resistance to your chosen damage type.' },
      { name: 'Breath Weapon', description: 'As an action, exhale destructive energy in a 5 by 30 foot line. Each creature must make a Dex save, taking 1d10 damage on a fail (scales with level). Prof-bonus uses per long rest.' },
      { name: 'Chromatic Warding', description: 'Starting at 5th level, as an action you gain immunity to your chosen damage type for 1 minute. Once per long rest.' },
    ],
    languages: ['Common', 'Draconic'],
    isSubrace: false,
  },
  {
    ...
    abilityScoreIncreases: { str: 2, cha: 1 },
    traits: [
      { name: 'Metallic Ancestry', description: 'Choose: Brass (fire), Bronze (lightning), Copper (acid), Gold (fire), or Silver (cold). You have resistance to your chosen damage type.' },
      { name: 'Breath Weapon', description: 'As an action, exhale destructive energy in a 5 by 30 foot line (Dex save). 1d10 damage scaling with level. Prof-bonus uses per long rest.' },
      { name: 'Metallic Breath Weapon', description: 'Starting at 5th level, gain a second breath weapon. As an action, exhale a 15-foot cone: Enervating (Con save, incapacitates) or Repulsion (Str save, pushes 20 ft). Once per long rest.' },
    ],
    languages: ['Common', 'Draconic'],
    isSubrace: false,
  },
  {
    ...
    abilityScoreIncreases: { str: 2, cha: 1 },
    traits: [
      { name: 'Gem Ancestry', description: 'Choose: Amethyst (force), Crystal (radiant), Emerald (psychic), Sapphire (thunder), or Topaz (necrotic). You have resistance to your chosen damage type.' },
      { name: 'Breath Weapon', description: 'As an action, exhale destructive energy in a 5 by 30 foot line (Dex save). 1d10 damage scaling with level. Prof-bonus uses per long rest.' },
      { name: 'Psionic Mind', description: 'You can speak telepathically with any creature within 30 feet that you can see.' },
      { name: 'Gem Flight', description: 'Starting at 5th level, as a bonus action, sprout spectral wings, gaining a flying speed equal to your walking speed for 1 minute. Once per long rest.' },
    ],
    languages: ['Common', 'Draconic'],
    isSubrace: false,
  },
