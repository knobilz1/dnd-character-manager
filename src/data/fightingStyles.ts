...
export const ALL_FIGHTING_STYLES: FightingStyle[] = [
  ...
  { id: 'close-quarters-shooter', name: 'Close Quarters Shooter', sourceBook: 'XGtE', hidden: true, classes: ['fighter'], description: 'When making a ranged attack while you are within 5 feet of a hostile creature, you do not have disadvantage on the attack roll. Your ranged attacks ignore half cover and three-quarters cover against targets within 30 feet. You also gain a +1 bonus to attack rolls on ranged attacks against targets within 30 feet.' },
  { id: 'mariner', name: 'Mariner', sourceBook: 'XGtE', hidden: true, classes: ['fighter', 'paladin', 'ranger'], description: 'As long as you are not wearing heavy armor or using a shield, you have a swimming speed and a climbing speed equal to your normal speed, and you gain a +1 bonus to AC.' },
  { id: 'tunnel-fighter', name: 'Tunnel Fighter', sourceBook: 'XGtE', hidden: true, classes: ['fighter'], description: 'You excel at defending narrow passages, doorways, and other tight spaces. As a bonus action, you can enter a defensive stance that lasts until the start of your next turn. While in this stance, you can make opportunity attacks without using your reaction, and you can use your reaction to make a melee attack against a creature that moves more than 5 feet while within your reach.' },
];
