...
export const TOWN_STORE: StoreSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Ruby dust (1,500 gp)',    category: 'treasure', weight: 0, priceCp: 150000,  priceLabel: '1,500 gp',  description: 'Required component for Contingency.' },
      ...
      { name: 'Powdered silver',         category: 'gear',     weight: 0, priceCp: 10000,   priceLabel: '100 gp',    description: 'Required component for Magic Circle and Planar Binding (100 gp).' },
      { name: 'Onyx (gem)',              category: 'treasure', weight: 0, priceCp: 7500,    priceLabel: '75 gp',     description: 'Required component for Animate Dead (black onyx stone worth 25 gp per corpse, typically bought in lots of 3).' },
    ],
  },
  {
    label: 'Clothing',
