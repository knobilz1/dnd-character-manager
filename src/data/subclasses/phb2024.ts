...
export const PHB2024_SUBCLASSES: Subclass[] = [
  ...
  { id: 'aberrant-mind-2024', name: 'Aberrant Mind', classId: 'sorcerer-2024', sourceBook: 'PHB2024',
    ...
    features: [
      ...
      { name: 'Psionic Sorcery', level: 6, description: 'When casting a Psionic Spell using a spell slot: expend Sorcery Points equal to the slot level (no additional components required beyond the slot).' },
  ...
  { id: 'draconic-bloodline-2024', name: 'Draconic Bloodline', classId: 'sorcerer-2024', sourceBook: 'PHB2024',
    ...
    features: [
      ...
      { name: 'Draconic Ancestor', level: 3, description: 'Choose a dragon type (Acid/Cold/Fire/Lightning/Poison). You can speak, read, and write Draconic. This determines your Elemental Affinity damage type and Dragon Wings damage.' },
      { name: 'Elemental Affinity', level: 6, description: 'When casting a spell that deals your Draconic Ancestry damage type: add Cha mod to one damage roll. Also: spend 1 SP to gain Resistance to that damage type for 1 hour.' },
