...
export const ALL_BEAST_FORMS: BeastForm[] = [
  ...
  // ── SRD beasts, CR 1/4 and lower (Beast Master companion pool) ──────────────
  // Generated from the SRD by tools/audit/gen_beasts.py — 31 entries.
  // Verifiable with tools/audit/beastcheck.py; do not hand-edit the numbers.
  {
    id: 'baboon', name: 'Baboon', cr: '0', size: 'Small', hp: 3, ac: 12,
    str: 8, dex: 14, con: 11,
    speed: { walk: 30, climb: 30 },
    attacks: [{ name: 'Bite', toHit: 1, damage: '1d4-1', damageType: 'piercing' }],
    specialAbilities: ['Pack Tactics'],
  },
  {
    id: 'badger', name: 'Badger', cr: '0', size: 'Tiny', hp: 3, ac: 10,
    str: 4, dex: 11, con: 12,
    speed: { walk: 20, burrow: 5 },
    attacks: [{ name: 'Bite', toHit: 2, damage: '1', damageType: 'piercing' }],
    specialAbilities: ['Keen Smell'],
  },
  {
    id: 'bat', name: 'Bat', cr: '0', size: 'Tiny', hp: 1, ac: 12,
    str: 2, dex: 15, con: 8,
    speed: { walk: 5, fly: 30 },
    attacks: [{ name: 'Bite', toHit: 0, damage: '1', damageType: 'piercing' }],
  ...
  {
    id: 'boar', name: 'Boar', cr: '1/4', size: 'Medium', hp: 11, ac: 11,
    str: 13, dex: 11, con: 12,
    speed: { walk: 40 },
    attacks: [{ name: 'Tusk', toHit: 3, damage: '1d6+1', damageType: 'slashing' }],
    specialAbilities: ['Charge', 'Relentless'],
  },
  {
    id: 'crab', name: 'Crab', cr: '0', size: 'Tiny', hp: 2, ac: 11,
    str: 2, dex: 11, con: 10,
    speed: { walk: 20, swim: 20 },
    attacks: [{ name: 'Claw', toHit: 0, damage: '1', damageType: 'bludgeoning' }],
    specialAbilities: ['Amphibious'],
  },
  {
    id: 'deer', name: 'Deer', cr: '0', size: 'Medium', hp: 4, ac: 13,
    str: 11, dex: 16, con: 11,
    speed: { walk: 50 },
    attacks: [{ name: 'Bite', toHit: 2, damage: '1d4', damageType: 'piercing' }],
  },
  {
    id: 'flying-snake', name: 'Flying Snake', cr: '1/8', size: 'Tiny', hp: 5, ac: 14,
    str: 4, dex: 18, con: 11,
    speed: { walk: 30, swim: 30, fly: 60 },
    attacks: [{ name: 'Bite', toHit: 6, damage: '1', damageType: 'piercing', notes: 'plus 3d4 poison' }],
    specialAbilities: ['Flyby'],
  },
  {
    id: 'giant-badger', name: 'Giant Badger', cr: '1/4', size: 'Medium', hp: 13, ac: 10,
    str: 13, dex: 10, con: 15,
    speed: { walk: 30, burrow: 10 },
    attacks: [{ name: 'Bite', toHit: 3, damage: '1d6+1', damageType: 'piercing' }, { name: 'Claws', toHit: 3, damage: '2d4+1', damageType: 'slashing' }],
    specialAbilities: ['Keen Smell'],
  },
  {
    id: 'giant-centipede', name: 'Giant Centipede', cr: '1/4', size: 'Small', hp: 4, ac: 13,
    str: 5, dex: 14, con: 12,
    speed: { walk: 30, climb: 30 },
    attacks: [{ name: 'Bite', toHit: 4, damage: '1d4+2', damageType: 'piercing' }],
  },
  {
    id: 'giant-crab', name: 'Giant Crab', cr: '1/8', size: 'Medium', hp: 13, ac: 15,
    str: 13, dex: 15, con: 11,
    speed: { walk: 30, swim: 30 },
    attacks: [{ name: 'Claw', toHit: 3, damage: '1d6+1', damageType: 'bludgeoning' }],
    specialAbilities: ['Amphibious'],
  },
  {
    id: 'giant-fire-beetle', name: 'Giant Fire Beetle', cr: '0', size: 'Small', hp: 4, ac: 13,
    str: 8, dex: 10, con: 12,
    speed: { walk: 30 },
    attacks: [{ name: 'Bite', toHit: 1, damage: '1d6-1', damageType: 'slashing' }],
    specialAbilities: ['Illumination'],
  },
  {
    id: 'giant-frog', name: 'Giant Frog', cr: '1/4', size: 'Medium', hp: 18, ac: 11,
  ...
  {
    id: 'giant-poisonous-snake', name: 'Giant Poisonous Snake', cr: '1/4', size: 'Medium', hp: 11, ac: 14,
    str: 10, dex: 18, con: 13,
    speed: { walk: 30, swim: 30 },
    attacks: [{ name: 'Bite', toHit: 6, damage: '1d4+4', damageType: 'piercing' }],
  },
  {
    id: 'giant-rat-diseased', name: 'Giant Rat (Diseased)', cr: '1/8', size: 'Small', hp: 7, ac: 12,
    str: 7, dex: 15, con: 11,
    speed: { walk: 30 },
    attacks: [{ name: 'Bite', toHit: 4, damage: '1d4+2', damageType: 'piercing' }],
    specialAbilities: ['Keen Smell', 'Pack Tactics'],
  ...
  {
    id: 'giant-weasel', name: 'Giant Weasel', cr: '1/8', size: 'Medium', hp: 9, ac: 13,
    str: 11, dex: 16, con: 10,
    speed: { walk: 40 },
    attacks: [{ name: 'Bite', toHit: 5, damage: '1d4+3', damageType: 'piercing' }],
    specialAbilities: ['Keen Hearing and Smell'],
  },
  {
  ...
  {
    id: 'hawk', name: 'Hawk', cr: '0', size: 'Tiny', hp: 1, ac: 13,
    str: 5, dex: 16, con: 8,
    speed: { walk: 10, fly: 60 },
    attacks: [{ name: 'Talons', toHit: 5, damage: '1', damageType: 'slashing' }],
    specialAbilities: ['Keen Sight'],
  },
  {
    id: 'hyena', name: 'Hyena', cr: '0', size: 'Medium', hp: 5, ac: 11,
    str: 11, dex: 13, con: 12,
    speed: { walk: 50 },
    attacks: [{ name: 'Bite', toHit: 2, damage: '1d6', damageType: 'piercing' }],
    specialAbilities: ['Pack Tactics'],
  },
  {
    id: 'jackal', name: 'Jackal', cr: '0', size: 'Small', hp: 3, ac: 12,
    str: 8, dex: 15, con: 11,
    speed: { walk: 40 },
    attacks: [{ name: 'Bite', toHit: 1, damage: '1d4-1', damageType: 'piercing' }],
    specialAbilities: ['Keen Hearing and Smell', 'Pack Tactics'],
  ...
  {
    id: 'lizard', name: 'Lizard', cr: '0', size: 'Tiny', hp: 2, ac: 10,
    str: 2, dex: 11, con: 10,
    speed: { walk: 20, climb: 20 },
    attacks: [{ name: 'Bite', toHit: 0, damage: '1', damageType: 'piercing' }],
  },
  {
    id: 'mule', name: 'Mule', cr: '1/8', size: 'Medium', hp: 11, ac: 10,
    str: 14, dex: 10, con: 13,
    speed: { walk: 40 },
    attacks: [{ name: 'Hooves', toHit: 2, damage: '1d4+2', damageType: 'bludgeoning' }],
    specialAbilities: ['Beast of Burden', 'Sure-Footed'],
  },
  {
    id: 'owl', name: 'Owl', cr: '0', size: 'Tiny', hp: 1, ac: 11,
    str: 3, dex: 13, con: 8,
    speed: { walk: 5, fly: 60 },
    attacks: [{ name: 'Talons', toHit: 3, damage: '1', damageType: 'slashing' }],
  ...
  {
    id: 'quipper', name: 'Quipper', cr: '0', size: 'Tiny', hp: 1, ac: 13,
    str: 2, dex: 16, con: 9,
    speed: { swim: 40 },
    attacks: [{ name: 'Bite', toHit: 5, damage: '1', damageType: 'piercing' }],
  ...
  {
    id: 'scorpion', name: 'Scorpion', cr: '0', size: 'Tiny', hp: 1, ac: 11,
    str: 2, dex: 11, con: 8,
    speed: { walk: 10 },
    attacks: [{ name: 'Sting', toHit: 2, damage: '1', damageType: 'piercing' }],
  },
  {
    id: 'sea-horse', name: 'Sea Horse', cr: '0', size: 'Tiny', hp: 1, ac: 11,
    str: 1, dex: 12, con: 8,
    speed: { swim: 20 },
    attacks: [],
  ...
  {
    id: 'spider', name: 'Spider', cr: '0', size: 'Tiny', hp: 1, ac: 12,
    str: 2, dex: 14, con: 8,
    speed: { walk: 20, climb: 20 },
    attacks: [{ name: 'Bite', toHit: 4, damage: '1', damageType: 'piercing' }],
    specialAbilities: ['Spider Climb', 'Web Sense', 'Web Walker'],
  },
  {
    id: 'stirge', name: 'Stirge', cr: '1/8', size: 'Tiny', hp: 2, ac: 14,
    str: 4, dex: 16, con: 11,
    speed: { walk: 10, fly: 40 },
    attacks: [{ name: 'Blood Drain', toHit: 5, damage: '1d4+3', damageType: 'piercing' }],
  },
  {
    id: 'vulture', name: 'Vulture', cr: '0', size: 'Medium', hp: 5, ac: 10,
    str: 7, dex: 10, con: 13,
    speed: { walk: 10, fly: 50 },
    attacks: [{ name: 'Beak', toHit: 2, damage: '1d4', damageType: 'piercing' }],
    specialAbilities: ['Keen Sight and Smell', 'Pack Tactics'],
  },
  {
    id: 'weasel', name: 'Weasel', cr: '0', size: 'Tiny', hp: 1, ac: 13,
    str: 3, dex: 16, con: 8,
    speed: { walk: 30 },
    attacks: [{ name: 'Bite', toHit: 5, damage: '1', damageType: 'piercing' }],
    specialAbilities: ['Keen Hearing and Smell'],
